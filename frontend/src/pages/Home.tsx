        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex space-x-4">
              {/* This should not show for authenticated users due to redirect, but as fallback */}
              <Link
                to="/login"
      ...
      <main className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">Manage School</span>
            <span className="block text-primary-600">Payments Easily</span>
          </h1>
              ...
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Create and process school fee payments through multiple
                    gateways including Edviron, PhonePe, and more.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Monitor all transactions with real-time status updates,
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Built with security in mind. All transactions are encrypted
                    and processed through trusted payment gateways.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Join thousands of schools already using our payment system.
          </p>
